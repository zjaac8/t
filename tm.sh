...
Docker()
{
	...
	Region $R
	echo "{\"family\":\"$RandStr\",\"networkMode\":\"awsvpc\",\"cpu\":\"256\",\"memory\":\"512\",\"requiresCompatibilities\":[\"EC2\",\"FARGATE\"],\"containerDefinitions\":[{\"name\":\"$RandStr\",\"image\":\"$IMAGE\",\"cpu\":2,\"command\":[\"start\",\"accept\",\"--token\",\"ayDMa3ja408jPdTBBzbTE52Mv9uWZ+QK963WOq7QVb4=\"],\"memoryReservation\":24,\"essential\":true}]}" > ~/docker.json
